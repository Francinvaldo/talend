...
package cursotalend.job_caga_produto_0_1;
...
/**
 * Job: job_caga_produto Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class job_caga_produto implements TalendJob {
	...
	private final String jobName = "job_caga_produto";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					job_caga_produto.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(job_caga_produto.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class SaidaProdutoStruct implements routines.system.IPersistableRow<SaidaProdutoStruct> {
		final static byte[] commonByteArrayLock_CURSOTALEND_job_caga_produto = new byte[0];
		static byte[] commonByteArray_CURSOTALEND_job_caga_produto = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_CURSOTALEND_job_caga_produto.length) {
					if (length < 1024 && commonByteArray_CURSOTALEND_job_caga_produto.length == 0) {
						commonByteArray_CURSOTALEND_job_caga_produto = new byte[1024];
					} else {
						commonByteArray_CURSOTALEND_job_caga_produto = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_CURSOTALEND_job_caga_produto, 0, length);
				strReturn = new String(commonByteArray_CURSOTALEND_job_caga_produto, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_CURSOTALEND_job_caga_produto) {
		 ...
		 * Compare keys
		 */
		public int compareTo(SaidaProdutoStruct other) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				SaidaProdutoStruct SaidaProduto = new SaidaProdutoStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "SaidaProduto");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:JeHrot+uV/EO59oGV3vKzQbtmxv5JBMsV4gQJxy/rCAmF7ecMos=");
				...
				String tableNameForSearch_tDBOutput_1 = "" + ((String) "stg_produto") + "";
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE " + tableName_tDBOutput_1
								+ "(cod_produto INT ,nom_produto VARCHAR2(28)  ,cod_departamento INT ,nom_departamento VARCHAR2(15)  ,marca INT ,nom_marca VARCHAR2(13)  )");
					}
				}
				String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1
						+ " (cod_produto,nom_produto,cod_departamento,nom_departamento,marca,nom_marca) VALUES (?,?,?,?,?,?)";
...
// # Outputs initialization
				SaidaProdutoStruct SaidaProduto_tmp = new SaidaProdutoStruct();
// ###############################
				...
				try {
					...
					sheetList_tFileInputExcel_1.addAll(
							regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "produto", false));
...
// # Output table : 'SaidaProduto'
									SaidaProduto_tmp.cod_produto = row1.cod_produto;
									SaidaProduto_tmp.nom_produto = row1.nom_produto;
									SaidaProduto_tmp.cod_departamento = null;
									SaidaProduto_tmp.nom_departamento = null;
									SaidaProduto_tmp.marca = null;
									SaidaProduto_tmp.nom_marca = null;
									SaidaProduto = SaidaProduto_tmp;
// ###############################
...
// Start of branch "SaidaProduto"
								if (SaidaProduto != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection(iterateId, 1, 1, "SaidaProduto");
									}

									whetherReject_tDBOutput_1 = false;
									if (SaidaProduto.cod_produto == null) {
										pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(1, SaidaProduto.cod_produto);
									}

									if (SaidaProduto.nom_produto == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, SaidaProduto.nom_produto);
									}

									if (SaidaProduto.cod_departamento == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(3, SaidaProduto.cod_departamento);
									}

									if (SaidaProduto.nom_departamento == null) {
										pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(4, SaidaProduto.nom_departamento);
									}

									if (SaidaProduto.marca == null) {
										pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(5, SaidaProduto.marca);
									}

									if (SaidaProduto.nom_marca == null) {
										pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(6, SaidaProduto.nom_marca);
									}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "SaidaProduto");
				}
	...
	public static void main(String[] args) {
		final job_caga_produto job_caga_produtoClass = new job_caga_produto();

		int exitCode = job_caga_produtoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_caga_produto.class.getClassLoader()
					.getResourceAsStream("cursotalend/job_caga_produto_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = job_caga_produto.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_caga_produto");
		}
...
/************************************************************************************************
 * 63809 characters generated by Talend Open Studio for Big Data on the 2 de
 * Abril de 2022 16h20min45s BRT
 ************************************************************************************************/