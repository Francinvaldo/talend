...
package cursotalend.job_caga_vendedor_0_1;
...
/**
 * Job: job_caga_vendedor Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class job_caga_vendedor implements TalendJob {
	...
	private final String jobName = "job_caga_vendedor";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					job_caga_vendedor.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(job_caga_vendedor.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class saida_vendedorStruct implements routines.system.IPersistableRow<saida_vendedorStruct> {
		final static byte[] commonByteArrayLock_CURSOTALEND_job_caga_vendedor = new byte[0];
		static byte[] commonByteArray_CURSOTALEND_job_caga_vendedor = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_CURSOTALEND_job_caga_vendedor.length) {
					if (length < 1024 && commonByteArray_CURSOTALEND_job_caga_vendedor.length == 0) {
						commonByteArray_CURSOTALEND_job_caga_vendedor = new byte[1024];
					} else {
						commonByteArray_CURSOTALEND_job_caga_vendedor = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_CURSOTALEND_job_caga_vendedor, 0, length);
				strReturn = new String(commonByteArray_CURSOTALEND_job_caga_vendedor, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_CURSOTALEND_job_caga_vendedor) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "saida_vendedor");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:z8kJBg5/y6cP60B5mqB6wm6n2kQD2MNe8Y+FJE5tPAVWljVsZyE=");
				...
				String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1
						+ " (cod_vendedor,des_vendedor) VALUES (?,?)";
...
// ###############################
				...
				try {
					...
					sheetList_tFileInputExcel_1.addAll(
							regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "vendedor", false));
...
//end%>
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.cod_vendedor = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.des_vendedor = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.des_vendedor = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
// # Output table : 'saida_vendedor'
									saida_vendedor_tmp.cod_vendedor = row1.cod_vendedor;
									saida_vendedor_tmp.des_vendedor = StringHandling.UPCASE(row1.des_vendedor);
...
// Start of branch "saida_vendedor"
								if (saida_vendedor != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection(iterateId, 1, 1, "saida_vendedor");
									}
									...
									if (saida_vendedor.cod_vendedor == null) {
										...
										pstmt_tDBOutput_1.setString(1, saida_vendedor.cod_vendedor);
									}

									if (saida_vendedor.des_vendedor == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, saida_vendedor.des_vendedor);
									}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "saida_vendedor");
				}
	...
	public static void main(String[] args) {
		final job_caga_vendedor job_caga_vendedorClass = new job_caga_vendedor();

		int exitCode = job_caga_vendedorClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_caga_vendedor.class.getClassLoader()
					.getResourceAsStream("cursotalend/job_caga_vendedor_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = job_caga_vendedor.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_caga_vendedor");
		}
...
/************************************************************************************************
 * 56565 characters generated by Talend Open Studio for Big Data on the 2 de
 * Abril de 2022 17h21min35s BRT
 ************************************************************************************************/