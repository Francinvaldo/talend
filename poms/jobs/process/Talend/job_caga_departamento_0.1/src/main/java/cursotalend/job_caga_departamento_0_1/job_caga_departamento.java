...
package cursotalend.job_caga_departamento_0_1;
...
/**
 * Job: job_caga_departamento Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class job_caga_departamento implements TalendJob {
	...
	private final String jobName = "job_caga_departamento";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					job_caga_departamento.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(job_caga_departamento.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class saida_departamentoStruct implements routines.system.IPersistableRow<saida_departamentoStruct> {
		final static byte[] commonByteArrayLock_CURSOTALEND_job_caga_departamento = new byte[0];
		static byte[] commonByteArray_CURSOTALEND_job_caga_departamento = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_CURSOTALEND_job_caga_departamento.length) {
					if (length < 1024 && commonByteArray_CURSOTALEND_job_caga_departamento.length == 0) {
						commonByteArray_CURSOTALEND_job_caga_departamento = new byte[1024];
					} else {
						commonByteArray_CURSOTALEND_job_caga_departamento = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_CURSOTALEND_job_caga_departamento, 0, length);
				strReturn = new String(commonByteArray_CURSOTALEND_job_caga_departamento, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_CURSOTALEND_job_caga_departamento) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "saida_departamento");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:1sFF8MUWiih3paCklC74wffWaKlT4QsEcnPsl3LC5w5cMEdlbGQ=");
				...
				String tableNameForSearch_tDBOutput_1 = "" + ((String) "stg_departamento") + "";
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE " + tableName_tDBOutput_1
							+ "(cod_departamento INT ,Departamento VARCHAR2(15)  )");
				}
				String insert_tDBOutput_1 = "INSERT INTO " + tableName_tDBOutput_1
						+ " (cod_departamento,Departamento) VALUES (?,?)";
...
// ###############################
				...
				try {
					...
					sheetList_tFileInputExcel_1.addAll(
							regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "Departamento", false));
...
// # Output table : 'saida_departamento'
									saida_departamento_tmp.cod_departamento = row1.cod_departamento;
									saida_departamento_tmp.Departamento = row1.Departamento;
...
// Start of branch "saida_departamento"
								if (saida_departamento != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection(iterateId, 1, 1, "saida_departamento");
									}
									...
									if (saida_departamento.cod_departamento == null) {
										...
										pstmt_tDBOutput_1.setInt(1, saida_departamento.cod_departamento);
									}

									if (saida_departamento.Departamento == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, saida_departamento.Departamento);
									}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "saida_departamento");
				}
	...
	public static void main(String[] args) {
		final job_caga_departamento job_caga_departamentoClass = new job_caga_departamento();

		int exitCode = job_caga_departamentoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_caga_departamento.class.getClassLoader().getResourceAsStream(
					"cursotalend/job_caga_departamento_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = job_caga_departamento.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_caga_departamento");
		}
...
/************************************************************************************************
 * 60009 characters generated by Talend Open Studio for Big Data on the 2 de
 * Abril de 2022 16h59min1s BRT
 ************************************************************************************************/